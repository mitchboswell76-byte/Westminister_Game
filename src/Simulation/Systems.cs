...
public interface ICharacterSystem { void TickCharacter(Character character, GameState s, GameRng rng); }
...
public sealed class NoOpSystems : IInputProcessor, ISchemeSystem, IEventSystem, ICharacterSystem, IMonthlySystem, IAnnualSystem, IAutosaveSystem, IUiDirtyMarker
{
    ...
    public void TickCharacter(Character character, GameState s, GameRng rng) { }
    public void TickMonthly(GameState s, GameRng rng) => s.MonthlyHookCount++;
