...
public record PolicyLever(string Id,string Name,string Category,string Subcategory,string Type,double Min,double Max,double Step,double Default,double CurrentValue,string Unit,string DisplayFormat,List<string> Dependencies,List<string> MutuallyExclusiveWith,double AiWeight,string PhaseTag);
